...
public class CreatorCompument {
    static BufferedImage createRoundButton(JLayeredPane label, int flur) {
        BufferedImage roundedImage = new BufferedImage(BeginPanel.widthLogin + 30, BeginPanel.heigthLogin + 30,
                BufferedImage.TYPE_INT_ARGB);
        Graphics2D g2d = roundedImage.createGraphics();
        g2d.setRenderingHint(RenderingHints.KEY_ANTIALIASING, RenderingHints.VALUE_ANTIALIAS_ON);
        g2d.setColor(new Color(0, 0, 0, flur));
        g2d.fillRoundRect(0, 0, BeginPanel.widthLogin + 30, BeginPanel.heigthLogin + 30,
                BeginPanel.widthLogin + 30 - 300, BeginPanel.heigthLogin + 30 - 20);
        g2d.dispose();
        return roundedImage;
    }
